...
**제품명**: d.ground (구 사내명: `construction-notice`)
...
**B. 건설사 입찰팀** — PM이 Room을 열고 입찰공고·성능요구서·과거 제안서 업로드 → 팀원이 평가 기준 즉시 조회
...
| W7 | Supabase **Pro 업그레이드** (PITR + 8GB storage), 첫 방(성수3 등 5종 PDF) 시드, QA, `dground.dconnect.kr` 배포 |
